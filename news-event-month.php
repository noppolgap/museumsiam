			...
			<div class="box-category-main news">
				<div class="box-title cf">
					...
					<div class="box-btn">
						<?  $link_page = "";
							...
							if($row_CAT['CONTENT_CAT_ID'] == $all_event_cat_id ){ $link_page = "event-month.php";}
							else{ $link_page = "news-month.php";}
						 ?>
				...
				<div class="box-news-main">
					...
					$date = ConvertBoxDate($row['EVENT_START_DATE']);
						...
						/*social*/
						$path = 'event-detail.php?MID='.$MID.'%26CID='.$row_CAT['CONTENT_CAT_ID'].'%26SID='.$row['SUB_CAT_ID'].'%26CONID='.$row['CONTENT_ID'].'%26date=month';
						...
						echo	'<a href="event-detail.php?MID='.$MID.'&CID='.$row_CAT['CONTENT_CAT_ID'].'&SID='.$row['SUB_CAT_ID'].'&CONID='.$row['CONTENT_ID'].'&date=month">';
						...
						echo	'<a href="event-detail.php?MID='.$MID.'&CID='.$row_CAT['CONTENT_CAT_ID'].'&SID='.$row['SUB_CAT_ID'].'&CONID='.$row['CONTENT_ID'].'&date=month" class="btn red">อ่านเพิ่มเติม</a>';
