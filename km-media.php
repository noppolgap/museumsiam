				...
				<div class="box-news-main">
					<div class="box-tumb-main cf">
						...
						while ($rowContent = mysql_fetch_array($rsContent)) {
							...
							$path = 'km-detail.php?MID=' . $MID . '%26CID=' . $categoryID . '%26CONID=' . $rowContent['CONTENT_ID'].'&link=media';
							...
							echo '<a href="km-detail.php?MID=' . $MID . '&CID=' . $CID . '&CONID=' . $rowContent['CONTENT_ID'] . '&PG=' . $currentPage . '&link=media"> ';
							...
							echo ' <a href="km-detail.php?MID=' . $MID . '&CID=' . $CID . '&CONID=' . $rowContent['CONTENT_ID'] . '&PG=' . $currentPage . '&link=media" class="btn red">อ่านเพิ่มเติม</a>';
