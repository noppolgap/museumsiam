			...
			<div class="box-category-main news">
				...
				<div class="box-news-main">
					...
					$date = ConvertBoxDate($row['EVENT_START_DATE']);
						...
						/*social*/
						$path = 'event-detail.php?MID='.$MID.'%26CID='.$categoryID.'%26SID='.$row['SUB_CAT_ID'].'%26CONID='.$row['CONTENT_ID'].'%26date=news_day';
						...
						echo	'<a href="event-detail.php?MID='.$MID.'&CID='.$categoryID.'&SID='.$row['SUB_CAT_ID'].'&CONID='.$row['CONTENT_ID'].'&date=news_day">';
						...
						echo	'<a href="event-detail.php?MID='.$MID.'&CID='.$categoryID.'&SID='.$row['SUB_CAT_ID'].'&CONID='.$row['CONTENT_ID'].'&date=news_day" class="btn red">อ่านเพิ่มเติม</a>';
