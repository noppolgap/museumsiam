	...
	<div class="container">
		<div class="box-nav">
			<ol class="cf">
				...
				<li class="active"><?=$rowCat['CONTENT_LOC'] ?></li>
			</ol>
		</div>
	</div>
</div>
		...
		<div class="box-right main-content">
			...
			<div class="box-category-main">
				...
				$sql_proc = "SELECT * FROM trn_product AS prod
											...
											WHERE prod.CAT_ID = " . $rowCat['CONTENT_CAT_ID'] . " AND prod.FLAG = 0 ";
				...
				<div class="box-item-main cf">
					...
					<?php while($row_proc = mysql_fetch_array($query_proc)) { ?>
					   ...
					   <div class="item">
						<a href="e-shopping-itemdetail.php?proid=<?=$row_proc['PRODUCT_ID'] ?>&cid=<?=$rowCat['CONTENT_CAT_ID'] ?>">
							<div class="box-pic">
				...
				<div class="box-pagination-main cf">
					<ul class="pagination">
						...
						$countContentSql = "SELECT count(1) as ROW_COUNT FROM trn_product WHERE CAT_ID = " . $rowCat['CONTENT_CAT_ID'] . " AND FLAG = 0 ";
