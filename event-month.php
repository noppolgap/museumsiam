			...
			<div class="container">
				<div class="box-nav">
					<ol class="cf">
						...
						<li class="active">
							กิจกรรมและข่าวสารทั้งหมดของทุกระบบ รายเดือน
						</li>
					</ol>
				</div>
			</div>
...
$dateEnd = ConvertBoxDate($row['EVENT_END_DATE']);
									/*social*/
									$path = 'event-detail.php?MID=' . $MID . '%26CID=' . $row['CAT_ID']  . '%26SID=' . $row['SUB_CAT_ID'] . '%26CONID=' . $row['CONTENT_ID'] . '%26date=event_month';
									...
									echo '<a href="event-detail.php?MID=' . $MID . '&CID=' . $row['CAT_ID']  . '&SID=' . $row['SUB_CAT_ID'] . '&CONID=' . $row['CONTENT_ID'] . '&date=event_month" class="btn red">'.$txt_more.'</a>';
