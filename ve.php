...
while($row = mysql_fetch_array($query)){
    ...
    $sqlCategory = "SELECT ".$LANG_SQL." ,
			...
			WHERE cat.flag = 0 AND cat.REF_MODULE_ID = ".$MID." AND content.CAT_ID = ".$style_exhibition." AND content.APPROVE_FLAG = 'Y' AND content.CONTENT_STATUS_FLAG = 0";
				...
				<div class="box-news-main">
					<div class="box-tumb-main cf ">
						<div class="box-tumb cf">
							<a href="ve-detail.php?MID=<?=$MID ?>&amp;CID=<?=$row_Category['CONTENT_CAT_ID'] ?>&amp;CONID=<?=$row_Category['CONTENT_ID'] ?>&SCID=<?=$row_Category['SUB_CAT_ID'] ?>">
								<div class="box-pic">
							...
							<div class="box-text">
								<div class="wrap">
									...
									<div class="box-btn cf">
										<a href="ve-detail.php?MID=<?=$MID ?>&amp;CID=<?=$row_Category['CONTENT_CAT_ID'] ?>&amp;CONID=<?=$row_Category['CONTENT_ID'] ?>&SCID=<?=$row_Category['SUB_CAT_ID'] ?>" class="btn red"><?=$txt_more ?></a>
...
<?  	}else if(($temporary_exhibition_show[$row_Category['SUB_CAT_ID']] < 3) && ($row_Category['SUB_CAT_ID'] != $permanent_exhibition)){
				...
				$temporary_exhibition_log[$row_Category['SUB_CAT_ID']] .= '<a href="ve-detail.php?MID='.$MID.'&amp;CID='.$row_Category['CONTENT_CAT_ID'].'&amp;CONID='.$row_Category['CONTENT_ID'].'&SCID='.$row_Category['SUB_CAT_ID'].'">';
				...
				$temporary_exhibition_log[$row_Category['SUB_CAT_ID']] .= '<a class="btn red" href="ve-detail.php?MID='.$MID.'&amp;CID='.$row_Category['CONTENT_CAT_ID'].'&amp;CONID='.$row_Category['CONTENT_ID'].'&SCID='.$row_Category['SUB_CAT_ID'].'">';
				...
				<div class="box-news-main">
					<div class="box-tumb-main cf ">
						<?
						    ...
						    $contentSql  .= $search_sql." ORDER BY
