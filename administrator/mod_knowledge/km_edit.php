			...
			<div class="mod-body-inner">
				...
				<div class="mod-body-main-content">
					...
					<div class="formCms">
						...
						<form action="km_action.php?edit&conid=<?=$contentID?>" method="post" name="formcms">
						...
						<? while($row = mysql_fetch_array($query)) {  ?>
							...
							<div class="btn_action">
								...
								<input type="button" value="ย้อนกลับ" class="buttonAction peter-river-flat-button" onclick="window.location.href = 'km_view.php?cid=<?=$id?>' ">
							</div>
						</form> 
					</div>
				</div>
