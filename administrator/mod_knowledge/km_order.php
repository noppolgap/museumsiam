...
<div class="orderContent">
	<div>
		<h1>จัดเรียง</h1>
		<input type="button" value="บันทึก" class="buttonAction emerald-flat-button"  onclick="updateOreder('km_order');">
	</div> 
	<ul id="sortable">
		<?php

			     $sql= "SELECT * FROM trn_content_detail  WHERE CONTENT_STATUS_FLAG <> 2 AND CAT_ID = '".$_GET['cid']."' ORDER BY ORDER_DATA DESC";
