 ...
 ?>
		...
		<div class="mod-body">
			<div class="buttonActionBox">
				<input type="button" value="สร้างใหม่" class="buttonAction emerald-flat-button" onclick="window.location.href = 'addMuseum.php'">
				...
				<?php while($row = mysql_fetch_array($query)) { ?>
					<div class="Main_Content" data-id="<?=$row['MUSEUM_DETAIL_ID'] ?>" >
						...
						<div class="floatL EditContent">
							<a href="editMuseum.php?MID=<?=$row['MUSEUM_DETAIL_ID'] ?>" class="EditContentBtn">Edit</a>
