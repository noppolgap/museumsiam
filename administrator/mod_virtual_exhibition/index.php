	...
	<div class="main-body marginC">
		...
		<div class="mod-body">
		    ...
		    <?php
			    ...
			    $sql= "SELECT * FROM trn_content_category WHERE Flag <> 2 AND REF_MODULE_ID = 5 ";
			 ...
			 ?>
					...
					<div class="Main_Content">
						...
						<div class="floatL nameContent">
							<div><? echo '<a href="viewVirsualExhib.php?p='.$row['CONTENT_CAT_ID'].' ">'.$row['CONTENT_CAT_DESC_LOC'].'</a>' ?></div>
