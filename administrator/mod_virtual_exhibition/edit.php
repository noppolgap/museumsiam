				...
				<div class="mod-body-main-content">
					...
					<div class="formCms">
						...
						<?php
							...
							$id = $_GET['p'];
						    $sql= "SELECT * FROM trn_content_category WHERE Flag <> 2 AND REF_MODULE_ID = 5  AND CONTENT_CAT_ID = ".$id." ";
						...
						<form action="action.php?edit&p=<?=$id?>" method="post" name="formcms">
							...
							<div>
								...
								<div class="floatL form_input"><input type="text" name="name_th" value="<? echo $row['CONTENT_CAT_DESC_LOC'] ?>" class="w90p" /></div>
								<div class="clear"></div>
							</div>	
							<div>
								<div class="floatL form_name">ชื่อ en</div>
								<div class="floatL form_input"><input type="text" name="name_en" value="<? echo $row['CONTENT_CAT_DESC_ENG'] ?>" class="w90p" /></div>
								<div class="clear"></div>
							</div>	
