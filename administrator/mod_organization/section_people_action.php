...
$secid = $_GET['secid'];
$returnPage = 'manage_people_section.php?secid='.$secid;
...
if (isset($_GET['add'])) {
	...
	$sql_max = "SELECT MAX( ORDER_DATA ) AS MAX_ORDER FROM mas_org WHERE ACTIVE_FLAG<>2 and PARENT_ORG_ID <> 0 and SECTION_ID =  " . $secid." AND DEPARTMENT_ID = -1";
