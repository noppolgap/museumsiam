		...
		<div class="mod-body">
			<div class="mod-body-inner">
				<div class="mod-body-inner-header">
					<div class="floatL titleBox">เพิ่มฝ่าย</div>
				</div>
				<div class="mod-body-main-content">

					<div class="formCms">
						<form action="section_action.php?add" method="post" name="formcms">
							<div>
							...
							<div class="btn_action">
								...
								<input type="button" value="ย้อนกลับ" class="buttonAction peter-river-flat-button" onclick="window.location.href = 'main_section_view.php'">
							</div>
						</form>
					</div>
				</div>
