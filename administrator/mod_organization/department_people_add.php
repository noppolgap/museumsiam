					...
					<div class="mod-body-inner">
						<div class="mod-body-inner-header">
							<div class="floatL titleBox">
								เพิ่มบุคคลากรแผนก <?=$departmentName ?>
							</div>
						</div>
						<div class="mod-body-main-content">

							<div class="formCms">
								<form action="department_people_action.php?add&secid=<?=$secid?>&did=<?=$did?>" method="post" name="formcms">
									<div>
								...
								<div class="clear"></div>
									...
									<div class="btn_action">
										...
										<input type="button" value="ย้อนกลับ" class="buttonAction peter-river-flat-button" onclick="window.location.href = 'manage_people_department.php?secid=<?=$secid?>&did=<?=$did?>'">
									</div>
								</form>
							</div>
						</div>
