								...
								<form action="action.php?edit&p=<?=$id ?>" method="post" name="formcms">
									...
									<div>
										...
										<div class="floatL form_input">
											<input type="text" name="name-th" value="<? echo $row['CONTENT_CAT_DESC_LOC'] ?>" class="w90p" />
										</div>
										<div class="clear"></div>
									</div>
									<div>
										...
										<div class="floatL form_input">
											<input type="text" name="name-en" value="<? echo $row['CONTENT_CAT_DESC_ENG'] ?>" class="w90p" />
										</div>
										<div class="clear"></div>
									</div>
