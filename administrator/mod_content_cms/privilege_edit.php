					...
					<div class="mod-body-inner">
						...
						<div class="mod-body-main-content">
							...
							<div class="formCms">
								...
								<form action="privilege_action.php?edit&cmsid=<?=$CMSID ?>" method="post" name="formcms">
									...
									<div>
										...
										<div class="floatL form_input">
											<input type="text" name="txtDescLoc" id ="txtDescLoc" value="<?=$row["CMS_DESC_LOC"] ?>" class="w90p" />
										</div>
									...
									<div>
										...
										<div class="floatL form_input">
											<input type="text" name="txtDescEng" id="txtDescEng" value="<?=$row["CMS_DESC_ENG"] ?>" class="w90p" />
										</div>
									...
									<div class="bigForm">
										...
										<div class="floatL form_input">
											<input type="text" name="txtDetailLoc" id = "txtDetailLoc" value="<?=$row["CMS_TEXT_LOC"] ?>" class="w90p" />
										</div>
										<span class="error" >* <span id = "detailThError" style="display:none">กรุณาระบุ Link URL</span> </span>
										<div class="clear"></div>
									</div>
