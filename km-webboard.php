 ...
 ?>
		...
		<div class="box-right main-content">
			...
			<div class="box-title-system cf">
				...
				<div class="box-btn">
				<?php
					$sql = "SELECT NAME , LAST_NAME , USER_ID FROM sys_app_user WHERE ID = ".intval($_SESSION['UID'])." AND CITIZEN_ID IS NOT NULL";
					$query = mysql_query($sql, $conn);
					if(mysql_num_rows($query) == 0){
						echo '<a href="#" onclick="editAccout(); return false;" class="btn red Atopic">ตั้งกระทู้</a>';
					}else{
