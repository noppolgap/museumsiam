			<div class="box-pic-main">
				<img src="images/th/service/knowlagepic-service1.jpg"/>
			</div>
			<div class="box-text1-main cf">
				<p class="text1"><img src="images/th/service/knowlagetitle1.png"/></p>
				<p class="text2">
			...
			<div class="box-text2-main cf">
				<p class="text1"><img src="images/th/service/knowlagetitle2.png"/></p>
				<p class="text2">
					<img src="images/th/service/knowlagepic-service2.png"/>
				</p>
				<p class="text3">
				...
				<p class="text5">
					<img src="images/th/service/knowlagetitle3.png"/>
				</p>
				<p class="text6">
					<a href="#" target="_blank"><img src="images/th/service/knowlagepic-service3.png"/></a>
				</p>
			</div>
			<hr class="line-gray"/>
			
			<div class="box-text3-main cf">
				<p class="text1"><img src="images/th/service/knowlagetitle4.png"/></p>
				<p class="text2">
					"ห้องคลังความรู้" ชั้น 1 อาคารสำนักงาน สถาบันพิพิธภัณฑ์การเรียนรู้แห่งชาติ เลขที่ 4 
ถนนสนามไชย เขตพระนคร กรุงเทพ 10230 
				</p>
				<p class="text3">
					<img src="images/th/service/knowlagetitle5.png"/>
				</p>
