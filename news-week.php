						...
						<div class="box-news-main">
							<div class="box-tumb-main cf">
								...
								while ($row = mysql_fetch_array($query)) {
									...
									/*social*/
									$path = 'news-detail.php?MID=' . $MID . '%26CID=' . $categoryID . '%26SID=' . $row['SUB_CAT_ID'] . '%26CONID=' . $row['CONTENT_ID'] . '%26date=news_week';
									...
									echo '<a href="news-detail.php?MID=' . $MID . '&CID=' . $categoryID . '&SID=' . $row['SUB_CAT_ID'] . '&CONID=' . $row['CONTENT_ID'] . '&date=news_week" class="btn red">อ่านเพิ่มเติม</a>';
